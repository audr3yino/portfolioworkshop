...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-6">
        I am a 5' 5" year undergraduate student studying rizzology 🤓 at <a href={ucdavis} target="_blank" className="link">Clown </a>. 
      </p>
      <p className="mb-6">
        I have a strong passion for women. Add another sentence here about your interests or drive or passion.
      </p>
      <p className="mb-6">
        Currently, I love being goofy ☝️🤓<a href={aggieworks} target="_blank" className="link">AggieWorks</a>. I also do love being tough and not showing emotion <a href={asa} target="_blank" className="link">!!!!</a>.
      </p>
